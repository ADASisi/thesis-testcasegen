...
def export_file_minimum_overlap_past(lib, inside_layer_name, outside_layer_name):
    gds_filename = f"min_{inside_layer_name}_overlap_past_{outside_layer_name}_test.gds"
